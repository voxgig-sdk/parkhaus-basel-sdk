...
|---|---|---|
| `ts/` | @voxgig-sdk/parkhaus-basel-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/parkhaus-basel-sdk \
      --repository voxgig-sdk/parkhaus-basel-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/parkhaus-basel-sdk` shows it, and
`npm trust revoke @voxgig-sdk/parkhaus-basel-sdk --id=<id>` removes it.
