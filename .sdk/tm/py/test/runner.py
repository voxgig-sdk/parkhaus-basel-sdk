...
class ParkhausBaselTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ParkhausBaselTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ParkhausBaselTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ParkhausBaselTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
