...
class ParkhausBaselTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ParkhausBaselTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ParkhausBaselTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ParkhausBaselTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
