...
// ParkhausBasel SDK pipeline test
//
...
{
    private static function utility(): ParkhausBaselUtility
    {
        return new ParkhausBaselUtility();
    }
    ...
    private static function ctx(array $over = []): ParkhausBaselContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ParkhausBaselContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ParkhausBaselOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ParkhausBaselError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ParkhausBaselOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ParkhausBaselMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ParkhausBaselOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ParkhausBaselMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ParkhausBaselOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ParkhausBaselMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ParkhausBaselSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ParkhausBaselMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ParkhausBaselResponse([]),
            'result' => new ParkhausBaselResult([]),
        ]);
        [, $err] = ParkhausBaselMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ParkhausBaselSpec([]),
            'response' => null,
            'result' => new ParkhausBaselResult([]),
        ]);
        [, $err] = ParkhausBaselMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ParkhausBaselSpec(['step' => 's']),
            'response' => new ParkhausBaselResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ParkhausBaselResult([]),
        ]);
        [, $err] = ParkhausBaselMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ParkhausBaselSpec(['step' => 's']),
            'response' => new ParkhausBaselResponse(self::resp(200, ['v' => 1])),
            'result' => new ParkhausBaselResult([]),
        ]);
        [, $err] = ParkhausBaselMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ParkhausBaselSpec(['step' => 's']),
            'response' => new ParkhausBaselResponse(self::resp(200, ['v' => 2])),
            'result' => new ParkhausBaselResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ParkhausBaselMakeResponse::call($ctx);
    ...
    {
        $preset = new ParkhausBaselResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ParkhausBaselSpec([]),
            'response' => new ParkhausBaselResponse([]),
            'result' => new ParkhausBaselResult([]),
        ...
        [$got, $err] = ParkhausBaselMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ParkhausBaselResult([])]);
        [, $err] = ParkhausBaselMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ParkhausBaselSpec([]), 'result' => null]);
        [, $err] = ParkhausBaselMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ParkhausBaselSpec(['step' => 's']),
            'result' => new ParkhausBaselResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ParkhausBaselOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ParkhausBaselMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ParkhausBaselSpec(['step' => 's']),
            'result' => new ParkhausBaselResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ParkhausBaselOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ParkhausBaselMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ParkhausBaselResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ParkhausBaselSpec([]),
            'result' => new ParkhausBaselResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ParkhausBaselMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ParkhausBaselMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ParkhausBaselError('boom', 'boom');
        $utility->fetcher = function (ParkhausBaselContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ParkhausBaselSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ParkhausBaselMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ParkhausBaselContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ParkhausBaselMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ParkhausBaselResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ParkhausBaselMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ParkhausBaselContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ParkhausBaselSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ParkhausBaselMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ParkhausBaselResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ParkhausBaselSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ParkhausBaselMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ParkhausBaselMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ParkhausBaselMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ParkhausBaselResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ParkhausBaselDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ParkhausBaselResult(['ok' => false])]);
        $this->expectException(ParkhausBaselError::class);
        ParkhausBaselDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ParkhausBaselResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ParkhausBaselMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ParkhausBaselMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ParkhausBaselBaseFeature();
        $b = new ParkhausBaselBaseFeature();
        ParkhausBaselFeatureAdd::call($ctx, $a);
        ParkhausBaselFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ParkhausBaselBaseFeature
    {
        $f = new ParkhausBaselBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ParkhausBaselFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ParkhausBaselContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ParkhausBaselSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ParkhausBaselPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ParkhausBaselPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ParkhausBaselResponse(['headers' => null]),
            'result' => new ParkhausBaselResult([]),
        ]);
        ParkhausBaselResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ParkhausBaselResultBody::call($ctx);
