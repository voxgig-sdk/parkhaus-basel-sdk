...
// ParkhausBasel SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ParkhausBaselTransformResponse
{
    public static function call(ParkhausBaselContext $ctx): mixed
    {
        ...
        $transform = ParkhausBaselHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
