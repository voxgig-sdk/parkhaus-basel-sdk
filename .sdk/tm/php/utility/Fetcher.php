...
// ParkhausBasel SDK utility: fetcher

class ParkhausBaselFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ParkhausBaselSDK/1.0)';
    ...
    public static function call(ParkhausBaselContext $ctx, string $fullurl, array $fetchdef): array
    {
