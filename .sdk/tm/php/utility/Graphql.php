...
// ParkhausBasel SDK utility: graphql
//
...
class ParkhausBaselGraphql
{
    ...
    // equivalent.
    public static function body(ParkhausBaselContext $ctx): mixed
    {
    ...
    public static function errors(ParkhausBaselContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
