...
// ParkhausBasel SDK utility: make_options

class ParkhausBaselMakeOptions
{
    ...
    public static function call(ParkhausBaselContext $ctx): array
    {
        ...
        //
        // `ParkhausBaselSchema::optspec()` is built from the model:
        ...
        $optspec = ParkhausBaselSchema::optspec();
