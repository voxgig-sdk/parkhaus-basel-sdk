...
// ParkhausBasel SDK ratelimit feature
...
class ParkhausBaselRatelimitFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _acquire(ParkhausBaselContext $ctx): void
    {
    ...
    private function _track(ParkhausBaselContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
