...
// ParkhausBasel SDK telemetry feature
...
class ParkhausBaselTelemetryFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _close(ParkhausBaselContext $ctx, bool $ok): void
    {
