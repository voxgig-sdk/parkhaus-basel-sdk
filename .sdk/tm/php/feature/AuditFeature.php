...
// ParkhausBasel SDK audit feature
...
class ParkhausBaselAuditFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _emit(ParkhausBaselContext $ctx, string $outcome): void
    {
