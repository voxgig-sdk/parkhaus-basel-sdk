...
// ParkhausBasel SDK cache feature
...
class ParkhausBaselCacheFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _through(ParkhausBaselContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
