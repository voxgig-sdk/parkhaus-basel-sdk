...
// ParkhausBasel SDK netsim feature
...
class ParkhausBaselNetsimFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _simulate(ParkhausBaselContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ParkhausBaselContext $ctx, array $applied): void
    {
        $client = $this->client;
