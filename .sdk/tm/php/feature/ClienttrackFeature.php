...
// ParkhausBasel SDK clienttrack feature
...
class ParkhausBaselClienttrackFeature extends ParkhausBaselBaseFeature
{
    ...
    public function PostConstruct(ParkhausBaselContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ParkhausBasel-SDK';
