# ParkhausBasel Ruby SDK Reference

Complete API reference for the ParkhausBasel Ruby SDK.
...
#### `ParkhausBaselSDK.test(testopts = nil, sdkopts = nil)`
...
| --- | --- | --- | --- |
| `free` | `Integer` | No | Number of free parking spaces |
| `geo_point_2d` | `Hash` | No | Geographic coordinates of the parking garage |
