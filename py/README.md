...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.ParkingData()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/parkhaus-basel-sdk/releases)) or
...
```
py/
├── parkhausbasel_sdk.py         -- Main SDK module
