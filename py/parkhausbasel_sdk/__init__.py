...
from parkhausbasel_sdk.utility import register

# Load features
from parkhausbasel_sdk.feature.base_feature import ParkhausBaselBaseFeature
from parkhausbasel_sdk.features import _has_feature, _make_feature
...
class ParkhausBaselSDK:
    ...
    def get_utility(self):
        return ParkhausBaselUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ParkhausBaselSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def ParkingData(self, data=None) -> "ParkingDataEntity":
        ...
        from parkhausbasel_sdk.entity.parking_data_entity import ParkingDataEntity
