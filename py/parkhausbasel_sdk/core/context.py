...
from parkhausbasel_sdk.core.helpers import get_ctx_prop, to_map
...
class ParkhausBaselContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ParkhausBaselControl()
        ...
        if isinstance(sp, ParkhausBaselSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ParkhausBaselResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ParkhausBaselResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ParkhausBaselError(code, msg, self)
