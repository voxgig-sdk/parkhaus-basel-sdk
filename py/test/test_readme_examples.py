# ParkhausBasel SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ParkhausBaselSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ParkhausBaselSDK(...) and ParkhausBaselSDK.test(...) become
#      ParkhausBaselSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "parkhausbasel_sdk"
_SDK_CLASS = "ParkhausBaselSDK"
