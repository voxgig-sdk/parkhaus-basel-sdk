# ParkhausBasel PHP SDK Reference

Complete API reference for the ParkhausBasel PHP SDK.
...
#### `ParkhausBaselSDK::test($testopts = null, $sdkopts = null)`
