...
class ParkhausBaselSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ParkhausBaselHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ParkhausBaselHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ParkhausBaselFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ParkhausBaselFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ParkhausBaselUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ParkhausBaselHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ParkhausBaselHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ParkhausBaselHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ParkhausBaselError($op . "_allow",
                "ParkhausBaselSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ParkhausBaselHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ParkhausBaselError("graphql_error",
                "ParkhausBaselSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function ParkingData($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_parking_data === null) {
                $this->_parking_data = new ParkingDataEntity($this, null);
            }
            return $this->_parking_data;
        }
        return new ParkingDataEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new ParkhausBaselSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
