...
// ParkhausBasel SDK rbac feature
...
class ParkhausBaselRbacFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _required(ParkhausBaselContext $ctx): ?string
    {
    ...
    private function _reject(ParkhausBaselContext $ctx, string $required): void
    {
    ...
    private function _track(ParkhausBaselContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
