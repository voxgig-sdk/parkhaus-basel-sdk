...
// ParkhausBasel SDK timeout feature
...
class ParkhausBaselTimeoutFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _with_timeout(ParkhausBaselContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ParkhausBaselContext $_ctx, float $ms): void
    {
        $client = $this->client;
