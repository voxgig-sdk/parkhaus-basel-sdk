...
// ParkhausBasel SDK proxy feature
...
class ParkhausBaselProxyFeature extends ParkhausBaselBaseFeature
{
    ...
    public function init(ParkhausBaselContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ParkhausBaselContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
