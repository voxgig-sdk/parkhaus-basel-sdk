...
// ParkhausBasel SDK debug feature
...
class ParkhausBaselDebugFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _finish(ParkhausBaselContext $ctx, bool $ok): void
    {
