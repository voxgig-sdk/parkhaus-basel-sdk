...
// ParkhausBasel SDK idempotency feature
...
class ParkhausBaselIdempotencyFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _mutating(ParkhausBaselContext $ctx): bool
    {
