...
// ParkhausBasel SDK metrics feature
...
class ParkhausBaselMetricsFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _record(ParkhausBaselContext $ctx, bool $ok): void
    {
