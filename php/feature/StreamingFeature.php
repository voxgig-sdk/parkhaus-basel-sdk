...
// ParkhausBasel SDK streaming feature
...
class ParkhausBaselStreamingFeature extends ParkhausBaselBaseFeature
{
    ...
    private function _iterate(ParkhausBaselResult $result): \Generator
    {
    ...
    private function _streamable(ParkhausBaselContext $ctx): bool
    {
