...
// ParkhausBasel SDK utility type

class ParkhausBaselUtility
{
    ...
    public static function copy(ParkhausBaselUtility $src): ParkhausBaselUtility
    {
        $u = new ParkhausBaselUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
