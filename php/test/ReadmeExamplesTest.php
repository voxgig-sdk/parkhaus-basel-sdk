...
// ParkhausBasel SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ParkhausBaselSDK::test)
...
{
    private const SDK_CLASS = 'ParkhausBaselSDK';
    ...
    private const SDK_BASE = 'parkhausbasel_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../parkhausbasel_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
