...
// ParkhausBasel SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ParkhausBaselOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ParkhausBaselOmni::structfix($now, Struct::undef()))
                        !== json_encode(ParkhausBaselOmni::structfix($val, Struct::undef()))) {
