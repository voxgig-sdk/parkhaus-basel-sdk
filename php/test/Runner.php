...
class ParkhausBaselTestRunner
{
    ...
    {
        $live = self::getenv('PARKHAUS_BASEL_TEST_LIVE');
        $override = self::getenv('PARKHAUS_BASEL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PARKHAUS_BASEL_TEST_EXPLAIN');
...
class_alias('ParkhausBaselTestRunner', 'Runner');
class_alias('ParkhausBaselHelpers', 'Helpers');
