...
// ParkhausBasel SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ParkhausBaselMakeRequest
{
    public static function call(ParkhausBaselContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ParkhausBaselResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ParkhausBaselResponse($fetched);
        } else {
