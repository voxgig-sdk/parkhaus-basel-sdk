...
import (
	...
	"github.com/voxgig-sdk/parkhaus-basel-sdk/go/entity"
	"github.com/voxgig-sdk/parkhaus-basel-sdk/go/feature"
	_ "github.com/voxgig-sdk/parkhaus-basel-sdk/go/utility"
)
...
// instead of `sdk.NewParkhausBaselSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ParkhausBaselSDK  { return NewParkhausBaselSDK(nil) }
func Test() *ParkhausBaselSDK { return TestSDK(nil, nil) }
