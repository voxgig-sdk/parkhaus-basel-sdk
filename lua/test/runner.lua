...
function runner.env_override(m)
  local live = runner.getenv("PARKHAUS_BASEL_TEST_LIVE")
  local override = runner.getenv("PARKHAUS_BASEL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PARKHAUS_BASEL_TEST_EXPLAIN")
