...
function runner.env_override(m)
  local live = runner.getenv("PARKHAUSBASEL_TEST_LIVE")
  local override = runner.getenv("PARKHAUSBASEL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PARKHAUSBASEL_TEST_EXPLAIN")
