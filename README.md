...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/parkhaus-basel` | `npm install @voxgig-sdk/parkhaus-basel` |
| Python | `voxgig-sdk-parkhaus-basel` | `pip install voxgig-sdk-parkhaus-basel` |
| PHP | `voxgig-sdk/parkhaus-basel` | `composer require voxgig-sdk/parkhaus-basel` |
| Golang | `github.com/voxgig-sdk/parkhaus-basel-sdk/go` | `go get github.com/voxgig-sdk/parkhaus-basel-sdk/go` |
| Ruby | `voxgig-sdk-parkhaus-basel` | `gem install voxgig-sdk-parkhaus-basel` |
| Lua | `voxgig-sdk-parkhaus-basel` | `luarocks install voxgig-sdk-parkhaus-basel` |
