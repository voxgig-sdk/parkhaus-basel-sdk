// Command ParkhausBasel-mcp is an MCP server exposing the ParkhausBasel
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ParkhausBasel_list  — list records of an entity
//	ParkhausBasel_load  — load a single record of an entity
//
