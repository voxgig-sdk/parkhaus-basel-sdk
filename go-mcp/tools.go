...
type Args struct {
	Entity string         `json:"entity" jsonschema:"parking_data"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ParkhausBaselSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "parkhaus-basel_list",
		Description: "List records from ParkhausBasel. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "parkhaus-basel_load",
		Description: "Load a single record from ParkhausBasel. " +
...
func runOp(client *sdk.ParkhausBaselSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ParkhausBaselSDK, name string) (sdk.ParkhausBaselEntity, error) {
	switch strings.ToLower(name) {
	case "parking_data":
		return client.ParkingData(nil), nil
