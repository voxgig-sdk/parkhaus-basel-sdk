...
AQL-driven CLI and REPL for the ParkhausBasel SDK. Positional arguments are
...
./parkhaus-basel-cli load 1 parking_data
./parkhaus-basel-cli load '{id:1}' parking_data
