...
func registerSDKWords(r *eng.Registry, client *sdk.ParkhausBaselSDK) {
...
func runOp(client *sdk.ParkhausBaselSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
